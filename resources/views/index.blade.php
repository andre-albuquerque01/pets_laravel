        ...
        <section>
            <div class="flex flex-wrap justify-center gap-10 max-sm:gap-2 xl:mr-40 xl:ml-40">
                @foreach ($itens as $item)
                    <a href="{{ route('detail', $item->id_itens) }}" class="max-sm: xl:w-96 max-sm:w-screen">
                        <div class="flex border xl:w-96 md:h-54 items-center">
                            <div class="xl:w-60 p-3" id="img">
                                {{-- <img src="{{ asset('storage/img/' . $item->file_name)}}" alt="Imagem do item" width="150" height="150"> --}}
                            ...
                            <div class="space-y-2 px-5" id="information">
                                ...
                                {{-- <div class="text-2xl" id="title">{{Str::limit($item->title, 10)}}</div> --}}
