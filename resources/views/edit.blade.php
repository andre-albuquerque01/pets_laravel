...
@section('navBar')
    ...
    <div class="items-center justify-center m-2">
        <form class="max-w-lg mx-auto mt-8" method="POST" action="{{ route('editItens', $itens->id_itens) }}"
            ...
            <div class="flex items-center justify-center">
                <label for="image"
                    ...
                    <input type="file" id="image" name="imagem" class="hidden" accept="image/*"
                        onchange="exibirImagem(event)" value="{{ asset('storage/img/' . $itens->file_name) }}">
            ...
            <div class="mb-4 mt-8">
                ...
                <input type="text" step="0.01" id="place" name="place"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none"
                    placeholder="Digite o local do produto" value="{{ $itens->place }}">
            </div>
            <div class="mb-4 mt-8">
