        ...
        <form class="max-w-lg mx-auto mt-8" method="POST" action="{{ route('registerIten') }}" enctype="multipart/form-data">
            ...
            <div class="flex items-center justify-center">
                <label for="image"
                    ...
                    <input type="file" id="image" name="imagem" class="hidden" accept="image/*"
                        onchange="exibirImagem(event)" required>
            ...
            <div class="mb-4 mt-8">
                ...
                <input type="text" id="title" name="title"
                    ...
                    placeholder="Digite o título do produto" minlength="3" maxlength="15" required>
            </div>
            <div class="mb-4 mt-8">
            ...
            <div class="mb-4 mt-8">
                ...
                <input type="number" step="0.01" id="price" name="price"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none"
                    placeholder="Digite a preço do produto" required>
            </div>
            <div class="mb-4 mt-8">
                ...
                <input type="text" step="0.01" id="place" name="place"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none"
                    placeholder="Digite o local do produto" required>
            </div>
            <div class="mb-4 mt-8">
                <label for="categoria" class="block text-gray-700 text-sm font-bold mb-2">Categoria:</label>
                <select class="w-full px-3 py-2 border bg-white border-gray-300 rounded-md shadow-sm focus:outline-none" id="categoria" name="category" required>
